...
import (
	...
	"github.com/amagow-ct/kin-openapi/openapi2"
...
func main() {
	...
	if len(flag.Args()) != 1 || filename == "" {
		log.Fatalf("Usage: go run github.com/amagow-ct/kin-openapi/cmd/validate@latest [--circular] [--defaults] [--examples] [--ext] [--patterns] -- <local YAML or JSON file>\nGot: %+v\n", os.Args)
	}
