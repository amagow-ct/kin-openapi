[![CI](https://github.com/amagow-ct/kin-openapi/workflows/go/badge.svg)](https://github.com/amagow-ct/kin-openapi/actions)
[![Go Report Card](https://goreportcard.com/badge/github.com/amagow-ct/kin-openapi)](https://goreportcard.com/report/github.com/amagow-ct/kin-openapi)
[![GoDoc](https://godoc.org/github.com/amagow-ct/kin-openapi?status.svg)](https://godoc.org/github.com/amagow-ct/kin-openapi)
...
* [OpenAPI `v3.1`](https://github.com/OAI/OpenAPI-Specification/blob/main/versions/3.1.0.md) Soon! [Tracking issue here.](https://github.com/amagow-ct/kin-openapi/issues/230)

Licensed under the [MIT License](./LICENSE).

## Contributors, users and sponsors
The project has received pull requests [from many people](https://github.com/amagow-ct/kin-openapi/graphs/contributors). Thanks to everyone!
...
Here's some projects that depend on _kin-openapi_:
  ...
  * (Feel free to add your project by [creating an issue](https://github.com/amagow-ct/kin-openapi/issues/new) or a pull request)
...
# Structure
  * _openapi2_ ([godoc](https://godoc.org/github.com/amagow-ct/kin-openapi/openapi2))
    * Support for OpenAPI 2 files, including serialization, deserialization, and validation.
  * _openapi2conv_ ([godoc](https://godoc.org/github.com/amagow-ct/kin-openapi/openapi2conv))
    * Converts OpenAPI 2 files into OpenAPI 3 files.
  * _openapi3_ ([godoc](https://godoc.org/github.com/amagow-ct/kin-openapi/openapi3))
    * Support for OpenAPI 3 files, including serialization, deserialization, and validation.
  * _openapi3filter_ ([godoc](https://godoc.org/github.com/amagow-ct/kin-openapi/openapi3filter))
    * Validates HTTP requests and responses
    * Provides a [gorilla/mux](https://github.com/gorilla/mux) router for OpenAPI operations
  * _openapi3gen_ ([godoc](https://godoc.org/github.com/amagow-ct/kin-openapi/openapi3gen))
    * Generates `*openapi3.Schema` values for Go types.

# Some recipes
## Validating an OpenAPI document
```shell
go run github.com/amagow-ct/kin-openapi/cmd/validate@latest [--circular] [--defaults] [--examples] [--ext] [--patterns] -- <local YAML or JSON file>
```
...
import (
	...
	"github.com/amagow-ct/kin-openapi/openapi3filter"
	"github.com/amagow-ct/kin-openapi/routers/gorillamux"
)
...
### v0.51.0
* Type `openapi3filter.Route` moved to `routers` (and `Route.Handler` was dropped. See https://github.com/amagow-ct/kin-openapi/issues/329)
...
* `amagow-ct/kin-openapi/openapi3filter.Router` moved to `amagow-ct/kin-openapi/routers/legacy`
